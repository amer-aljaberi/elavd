      ...
      <div className="container relative mx-auto px-4 md:px-6">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          ...
          >
            ...
            <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold text-primary-foreground mb-3 sm:mb-4 tracking-tight font-cairo leading-tight sm:leading-normal">
              {title}
            </h1>
            {subtitle && (
